        ...
        public void Connect(string userName)
        {
            ...
            if (ConnectedUsers.Count(x => x.ConnectionId == id) == 0)
            {
                ...
                ConnectedUsers.Add(new Users
                    {ConnectionId = id, UserName = userName, UserImage = UserImg, LoginTime = logintime});
                // send to caller
        ...
        public void SendPrivateMessage(string toUserId, string message)
        {
            ...
            if (toUser != null && fromUser != null)
            {
                ...
                Clients.Client(toUserId)
                    .sendPrivateMessage(fromUserId, fromUser.UserName, message, UserImg, CurrentDateTime);
